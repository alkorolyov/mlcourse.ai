...
#  - [Exploratory data analysis with Pandas](https://mlcourse.ai/articles/topic1-exploratory-data-analysis-with-pandas/), the same as an interactive web-based [Kaggle Notebook](https://www.kaggle.com/kashnitsky/topic-1-exploratory-data-analysis-with-pandas)
#  - first lectures in the mlcourse.ai [YouTube playlist ](https://www.youtube.com/watch?v=QKTuw4PNOsU&list=PLVlY_7IJCMJeRfZ68eVfEcu-UcN9BbwiX) 
...
# 
# ### How to get help <a class="tocSkip">
# In [ODS Slack](https://opendatascience.slack.com) (if you don't have access, you can join via the [ods.ai](https://ods.ai) "Join #slack" button), we have a channel **#mlcourse_ai_news** with announcements from the course team.
# You can discuss the course content freely in the **#mlcourse_ai** channel (we still have a huge Russian-speaking group, they have a separate channel **#mlcourse_ai_rus**). This particular assignment being a bonus, is discussed in a dedicated pinned thread __#a1_bonus__. in the __#mlcourse_ai_news__ channel.
# 
# Here's how you reply in a thread (press this dialog icon to drill down into a thread):
# 
# <img src="https://habrastorage.org/webt/8-/ek/08/8-ek08iyvdtvafin7sixnqnzw-g.png" />
# 
# Please use threads for your questions and help each other without sharing correct code and answers. 
# 
# 
# ### Assignment <a class="tocSkip">
...
#  
# *For discussions, please stick to [ODS Slack](https://opendatascience.slack.com/), channel __#mlcourse_ai_news__, pinned thread __#a1_bonus__. If you are sure that something is not 100% correct, please leave your feedback via the mentioned webform ↑*
# 
# -----
...
# **<font color='red'>Question 8.</font> What are the most and least common age groups among the participants of the 2008 Olympics?**
